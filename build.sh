...
javac --release 17 -cp "$CP" -d work/classes src/main/java/localagent/*.java
javac --release 17 -cp "$CP:work/classes" -d work/test-classes src/test/java/localagent/*.java
java -Djava.awt.headless=true -cp "$CP:work/classes:work/test-classes" localagent.AgentTests
java -Djava.awt.headless=true -cp "$CP:work/classes:work/test-classes" localagent.ComposerTests
java -Djava.awt.headless=true -cp "$CP:work/classes:work/test-classes" localagent.TimeoutTests
...
jar --create --file build/Burp-Local-Agent.jar -C work/classes .
echo "Built build/Burp-Local-Agent.jar"
